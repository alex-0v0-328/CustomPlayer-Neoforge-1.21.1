...
//  ⚠ The menu carries no extra data on open -- the body it shows is always the opener's own, so there
//  is nothing to write into the buffer. IMenuTypeExtension.create is still what registers it.
